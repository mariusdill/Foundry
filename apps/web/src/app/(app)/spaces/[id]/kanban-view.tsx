...
function KanbanCard({ page }: { page: PageWithUser }) {
	return (
		<Link href={`/pages/${page.id}`}>
			<div className="group rounded-lg border border-[color:var(--border-subtle)] bg-card/95 p-3 shadow-[var(--shadow-xs)] transition-all hover:border-[color:var(--border-muted)] hover:shadow-[var(--shadow-sm)]">
